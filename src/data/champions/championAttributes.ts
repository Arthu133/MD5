...
const championOverrides: Record<string, Partial<Record<ChampionAttributeKey, number>>> = {
  ...
  Jinx: { hypercarry: 96, scaling: 94, dps: 94, resetChampion: 92, siege: 85, objectiveControl: 82 },
  ...
  KogMaw: { hypercarry: 97, scaling: 95, lateGame: 96, antiTank: 94, dps: 96, longRange: 86, lowRange: 30, objectiveControl: 84 },
  ...
  Twitch: { hypercarry: 94, scaling: 92, teamFight: 90, dps: 92, pickoff: 82, highRisk: 78 },
  ...
  JarvanIV: { engage: 94, dive: 92, junglePressure: 88, earlyGame: 84, teamFight: 86, crowdControl: 82, objectiveControl: 84 },
  ...
  Ivern: { protectCarry: 94, shielding: 96, utility: 95, junglePressure: 78, peel: 90, disengage: 82, objectiveControl: 84, visionControl: 92 },
  Janna: { disengage: 99, peel: 98, protectCarry: 96, shielding: 94, utility: 96, scaling: 80 },
  Nunu: { objectiveControl: 99, junglePressure: 86, sustain: 88, earlyGame: 82, roaming: 88 },
  Kalista: { objectiveControl: 94, dps: 88, earlyGame: 94, laneBully: 92, highRisk: 82 },
  Maokai: { objectiveControl: 88, visionControl: 94, zoneControl: 92, engage: 90, frontline: 88 },
  Zyra: { objectiveControl: 82, zoneControl: 94, visionControl: 78, teamFight: 86, poke: 88 },
  Heimerdinger: { objectiveControl: 86, zoneControl: 95, siege: 92, waveClear: 90, laneBully: 88 },
  Sejuani: { objectiveControl: 86, engage: 94, frontline: 92, teamFight: 90, crowdControl: 94 },
  Brand: { objectiveControl: 80, zoneControl: 90, teamFight: 90, burst: 92, dps: 84 },
  Fiddlesticks: { objectiveControl: 86, visionControl: 90, teamFight: 94, zoneControl: 92, burst: 90 },
  Varus: { objectiveControl: 82, dps: 88, poke: 92, longRange: 90, pickoff: 84 },
  Tristana: { objectiveControl: 88, dps: 92, siege: 92, earlyGame: 86, resetChampion: 88 },
  Kaisa: { objectiveControl: 84, dps: 94, hypercarry: 92, dive: 84, scaling: 92 },
};
